export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx1caab6cec6e4b37f",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "49636d99013e16405b9c5555c960dc26",
  ...
  USERS: [
    {
      ...
      name: "从从",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oRjVs5sjO30Ll55EoaEJd1ox06qY",
      // 你想对他发送的模板消息的模板ID
    ...
    }, 
    {
      ...
      useTemplateId: "MBcGNXs4BNXAERwF0aa7Xa7m1MoCfZ86uihUmRQ0O0k	",
      province: "安徽",
      city: "淮南",
      openUrl: "https://wangxinleo.cn"
    }, 
    {
      name: "彤彤", 
      id: "oRjVs5qjVC924yA--h3UzwuGwJDo",
      useTemplateId: "Xr7nZBbcebfQUkQ-VIMbMCqpMEiquJ-RjE5TRMYVFvo",
      province: "安徽",
      city: "淮南",
      openUrl: "https://s.weibo.com/top/summary"
    }, 
  ...
  CALLBACK_TEMPLATE_ID: "Xr7nZBbcebfQUkQ-VIMbMCqpMEiquJ-RjE5TRMYVFvo",

  // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
  CALLBACK_USERS: oRjVs5k-gFlWyNV4IUYUDdwuV6Qg
    {
      // 一般都填自己
      name: "战帅",
   ...
   */
  FESTIVALS: [
    {"type": "生日", "name": "战帅", "year": "2002", "date": "01-09"},
